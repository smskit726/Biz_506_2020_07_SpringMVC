...
<html lang="ko">
  <head>
    ...
    <link href="${rootPath}/static/css/index.css?ver=09281" rel="stylesheet" />
    <script src="https://code.jquery.com/jquery-latest.min.js"></script>
    <script>
    	// js 파일에서 el tag의 ${rootPath} 값을 참조하기 위해서
    	// rootPath 변수를 전역으로 선언해 둔다.
    	var rootPath = "${rootPath}"
    	// main-nav.js 파일에서 el tag 변수값을 사용할 수 없기 때문에 별도로 두개의 변수를 선언하고,
    	// headerName과 token값을 저장해준다.
    	// *.js 파일에서는 백팃(`)을 사용하여 해당 변수를 사용 할 수 있다.
    	var csrf_header = "${_csrf.headerName}"
    	var csrf_token = "${_csrf.token}"
    </script>
    <script src="${rootPath}/static/js/main-nav.js?ver=1007_2"></script>
  </head>
  <body>
    <header>
