$(function () {
  ...
  $("#naver-search").click(function () {
    ...
    // csrf 관련 값을 같이 보내주어야 정상적으로 서버에서 데이터를 받아들인다
    // jsp 파일에서 spring form을 사용하면 관련된 부분을 자동으로 설정을 해주지만 ajax를 사용해서
    // POST로 전송할 경우는 자동으로 설정이 되지 않아 임의로 값을 지정해 주어야 한다.
    $.ajax({
