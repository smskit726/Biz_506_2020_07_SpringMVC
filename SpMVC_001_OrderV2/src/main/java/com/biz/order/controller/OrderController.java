...
public class OrderController {
	...
	/*
	 * browser에서 order request를 실행할 때(요청을 할 때)
	...
	public String getOrder(String seq, String name, Model model) {
		...
		// 서비스에 seq(34)를 전달하고
		// 데이터 레코드를 SELECT 한 결과를 받아서 orderVO에 담는다
		 ...
		 * 이 때, model 에 담겨있는 데이터를 사용하여 Rendering 할 때 사용하라! 
		 */
	...
	public String insert(String o_num, String o_date, String o_cnum,
		...
		/*
		 * web browser의 주소창에 .../order/list 라고 입력한 후 Enter를 누른 것과 같이
